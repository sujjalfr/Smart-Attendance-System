...
why is face capture savign new iamges again and again in 7saturday folder but it is sunday also it is saving images again and again why is it fix that do not save unwanted images #codebase /home/sujjalbtw/Projects/Smart-Attendance-System/backend/smart_attendance/media/temp/7saturday it is saving insunday which is good but in saturday folder it is saving and saving after each face scan fix that 

while adding students where is email asking also for admin manage teachers where is add teachers form also teacher has email while adding student update student adding form to include email and for teacher phone number as well as email #codebase  